...
## 2024-05-19 - Semantic ARIA roles for Modals
**Learning:** Custom interactive modal components frequently lack proper roles for assistive technologies and visibility for keyboard focus.
**Action:** When building or enhancing modal components, ensure explicit ARIA roles (`role="dialog"`, `aria-modal="true"`) are implemented on the container and interactive children have proper focus states using Tailwind's `focus-visible:ring-2 focus-visible:outline-none`.
