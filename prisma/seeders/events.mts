...
const events = [
	...
	},
	{
		...
		type: EventType.ALL,
		description: "Welcome to the Hack The Hill IIII event! We're excited to have you here.",
		descriptionFr: "Bienvenue à l'événement Hack The Hill IIII! Nous sommes ravis de vous avoir ici.",
		room: "Room 2",
		maxCheckIns: 1,
	},
	{
