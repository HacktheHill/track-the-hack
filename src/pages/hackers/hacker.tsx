				...
				{Object.keys(groupedData).map((category, index) => (
					<div key={index}>
						<div className="flex justify-center">
							<h2 className="self-center px-3 py-2 font-[Coolvetica] text-2xl font-normal text-dark-primary-color">
								{category}
							</h2>
						</div>
							...
							<div key={itemIndex} className={paragraphClass}>
								...
								{item.type === "select" ? (
									<select
										id={item.name}
										name={item.name}
										className="col-md-6 bg-background1 hover:bg-background1/50 w-[50%] rounded-[100px] border-none px-5 py-2 font-rubik text-dark-primary-color shadow-md transition-all duration-500"
									...
									<input
										...
										name={item.name}
										type={item.type}
										className="/50 bg-background1 hover:bg-background2 w-[50%] rounded-[100px] border-none px-4 py-2 font-rubik text-dark-primary-color shadow-md	outline-none transition-all duration-500"
										defaultValue={
				...
				<OnlyRole filter={role => role === Role.ORGANIZER}>
					<>
						<div className="flex justify-center py-4">
							<h2 className="self-center py-4 font-[Coolvetica] text-2xl font-normal text-dark-primary-color ">
								Debug Information
							</h2>
						</div>
