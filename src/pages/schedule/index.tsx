...
const Schedule: NextPage = () => {
	...
	// ⚡ Bolt: Memoize expensive array calculations and slow date string conversions
	// This reduces re-renders by preventing re-evaluation on every component update.
