...
const Schedule: NextPage = () => {
	...
	// Keep track of current time and update every minute to re-filter events that just ended
	...
	// Memoize expensive array operations (filter, sort, reduce) to prevent them from running on every render
	...
	}, [query.data, currentTime, tab, dateLocale]);
