...
const Schedule: NextPage = () => {
	...
	// ⚡ Bolt: Memoized expensive array operations (filter, sort, reduce) to prevent unnecessary recalculations on every render.
	// Expected impact: Eliminates O(N log N) sorting and O(N) filtering overhead during standard re-renders.
