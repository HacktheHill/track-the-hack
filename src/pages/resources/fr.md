...
- **Devpost**: [Devpost de Hack the Hill III](https://hack-the-hill-iii.devpost.com/)
...
### Signalement d'incidents et contacts d'urgence

**Urgence:** Sur le campus, appelez les Services de protection de l'Université d'Ottawa au **613-562-5411**. Hors campus, composez le **9-1-1**. Communiquez d'abord avec les services d'urgence. Lorsque vous êtes en sécurité, informez l'équipe organisatrice.

Pour signaler une inconduite, du harcèlement, une violation des règles, de la tricherie ou toute autre préoccupation:

- **Daniel Thorp:** 613-809-9840
- **Agam Singh:** 289-885-4412
- **Courriel:** [president@ctn-rtc.org](mailto:president@ctn-rtc.org)

Ne publiez pas de renseignements sensibles sur un incident dans un espace public.

Vous pouvez signaler directement un incident à MLH si vous n'êtes pas à l'aise de communiquer avec un organisateur de l'événement. Les signalements sont transmis à l'équipe d'intervention de MLH et peuvent demeurer anonymes.

- **MLH Canada:** +1 343-453-4532 · [incidents@mlh.io](mailto:incidents@mlh.io)

[Code de conduite de MLH](https://github.com/MLH/mlh-policies/blob/main/code-of-conduct.md) · [Renseignements d'urgence de l'Université d'Ottawa](https://www.uottawa.ca/fr/urgence) · [Politique des participants et de l'événement](https://docs.google.com/document/d/1mEmObs9W3Q_YJWZ26kinqstjbGlp90BIG_QOxKLwW5Q/edit)

---

### Obtenir de l'aide avec les problèmes techniques

Un problème technique? Vous pouvez:

- **En ligne**: Créez un ticket dans le canal [`#get-help`](https://discord.gg/ryFTjgx4xR) sur Discord.
- **En personne**: Trouvez un organisateur ou un mentor.
