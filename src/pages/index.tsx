...
const Home: NextPage = () => {
	...
	return (
		<App className="items-left relative flex flex-col justify-center gap-2 bg-default-gradient px-8 py-6 short:gap-8">
			<Image priority src={leavesSVG} alt="Leaves" className="absolute inset-0 top-auto w-full" />
			...
			<h1 className="relative z-10 flex h-fit w-1/2 flex-wrap gap-4 lg:w-full">
				<Image priority src={hackSVG} alt="Hack" height={120} />
				<Image priority src={theSVG} alt=" the " height={120} />
				<Image priority src={hillSVG} alt="Hill" height={140} />
			</h1>
		</App>
	);
};
