...
const Tabs = (props: { names: string[]; children: React.ReactNode }) => {
	...
	return (
		<div className="flex flex-col items-center gap-6">
			<div role="tablist" aria-label="Tabs" className="flex gap-4">
				{names.map((name, index) => (
					<button
						...
						} p-4 font-coolvetica text-light-color focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2`}
			...
			<div role="tabpanel" id={`tabpanel-${activeTab}`} aria-labelledby={`tab-${activeTab}`} className="w-full">
