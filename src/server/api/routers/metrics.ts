...
export const metricsRouter = createTRPCRouter({
	getMetrics: publicProcedure.query(async ({ ctx }) => {
		...
		// Reuse previously calculated confirmed and walkIn counts to save DB queries
		const attendees = confirmed + walkIn + ORGANIZER_COUNT + MENTOR_COUNT + SPONSOR_COUNT + GUEST_COUNT;
